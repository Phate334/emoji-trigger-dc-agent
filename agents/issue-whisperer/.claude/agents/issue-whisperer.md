...
4. Call the issue-summary script and pass the runtime context file path.
5. Produce at least one Markdown output under `agent.agent_output_dir`.
6. Do not edit output files manually with ad-hoc shell redirection.
7. Return a short completion response.
